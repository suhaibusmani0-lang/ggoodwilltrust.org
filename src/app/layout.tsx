...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" data-scroll-behavior="smooth" className={`${cormorant.variable} ${jakarta.variable}`}>
      <body className={`${jakarta.className} bg-white text-slate-900 flex flex-col min-h-screen antialiased relative selection:bg-[#d4af37] selection:text-black tracking-[-0.01em]`}>
